...
const isLoggedIn = useSelector((state) => state.auth.isLoggedIn);
  ...
  return (
    <>
      <section>
        <div className="shadow-s1 p-8 rounded-lg  mb-12 mt-10">
          ...
          <div className="grid grid-cols-3 gap-8 mt-8">
            <div className="shadow-s3 border border-green bg-green_100 p-8 flex items-center text-center justify-center gap-5 flex-col rounded-xl">
              <BsCashCoin size={70} className="text-green" />
              <div>
                <Title level={4}>{income?.balance} </Title>
                <Title level={4}>Balance</Title>
              </div>
            </div>
            <div className="shadow-s3 border border-green bg-green_100 p-8 flex items-center text-center justify-center gap-5 flex-col rounded-xl">
              <CiMedal size={70} className="text-green" />
              <div>
                <Title level={4}>2</Title>
                <Title level={4}>Items Won</Title>
              </div>
            </div>
            <div className="shadow-s3 border border-green bg-green_100 p-8 flex items-center text-center justify-center gap-5 flex-col rounded-xl">
              <GiBarbedStar size={70} className="text-green" />
              <div>
                <Title level={4}>100</Title>
                <Title level={4}>Your Products </Title>
              </div>
            </div>
            {role === "admin" && (
              <>
                <div className="shadow-s3 border border-green bg-green_100 p-8 flex items-center text-center justify-center gap-5 flex-col rounded-xl">
                  <MdOutlineCategory size={70} className="text-green" />
                  <div>
                ...
                <div className="shadow-s3 border border-green bg-green_100 p-8 flex items-center text-center justify-center gap-5 flex-col rounded-xl">
                  <HiOutlineUsers size={70} className="text-green" />
                  <div>
                    <Title level={4}>100</Title>
