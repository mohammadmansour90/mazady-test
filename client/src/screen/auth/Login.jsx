...
export const Login = () => {
  ...
  const {  isLoggedIn,  isError } = useSelector(
    (state) => state.auth
  );
  ...
  const handleLogin = (e) => {
    ...
    return toast.error("Only Amman Arab University emails are allowed!");
  };

    // ✅ dispatch inside handler
