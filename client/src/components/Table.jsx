        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500">
          <thead className="text-xs text-gray-700 uppercase bg-gray-100">
            <tr>
              ...
              <th scope="col" className="px-6 py-3">Current Bid (JOD)</th>
          ...
          <tbody>
            {products?.map((product, index) => (
              <tr className="bg-white border-b hover:bg-gray-50" key={product._id || index}>
                <td className="px-6 py-4">{index + 1}</td>
                <td className="px-6 py-4">{product?.title?.slice(0, 15)}...</td>
                <td className="px-6 py-4">{product?.commition}%</td>
                <td className="px-6 py-4">{product?.price}</td>
                <td className="px-6 py-4">{product?.price}</td>
                <td className="px-6 py-4">
                  <img className="w-10 h-10" src={product?.image?.filePath} alt="Product" />
                </td>
